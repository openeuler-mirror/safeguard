...
func TestLSMListContainsBPF(t *testing.T) {
	...
	assert.True(t, lsmListContainsBPF("bpf"))
...
func TestCmdlineHasBPFLSM(t *testing.T) {
	...
	assert.False(t, cmdlineHasBPFLSM(""))
}
